// =============================================================================
// AI · FRS · Settings tab — feature status, license, cameras, processing
// health + the public-dashboard / data-ingest integration panel. Scoped to the
// FRS scenario; edits here never touch any other scenario's settings.
// =============================================================================
...
// FRS-specific purpose blurb.
const scenarioPurpose = () =>
  "Recognize enrolled people and review related events.";
