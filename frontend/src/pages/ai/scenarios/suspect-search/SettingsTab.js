// =============================================================================
// AI · Suspect Search · Settings tab — feature status, license, cameras, processing
// health + the public-dashboard / data-ingest integration panel. Scoped to the
// Suspect Search scenario; edits here never touch any other scenario's settings.
// =============================================================================
...
import ScenarioIntegrationPanel from "../../../../components/ai/ScenarioIntegrationPanel";
...
// Suspect Search-specific purpose blurb.
const scenarioPurpose = () =>
  "Find matching people, bags or helmets from recorded video.";
...
const SettingsTab = ({ scenario }) => {
  ...
  return (
    <div className="p-6 w-full space-y-5 h-full overflow-y-auto">
      ...
      <ScenarioIntegrationPanel slug={scenario.slug} scenarioName={scenario.name} />
