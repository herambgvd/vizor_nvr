// =============================================================================
// AI · ANPR · Settings tab — feature status, license, cameras, processing
// health + the public-dashboard / data-ingest integration panel. Scoped to the
// ANPR scenario; edits here never touch any other scenario's settings.
// =============================================================================
...
// ANPR-specific purpose blurb.
const scenarioPurpose = () =>
  "Read vehicle license plates and match them against named lists.";
