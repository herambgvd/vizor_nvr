// =============================================================================
// AI · PPE · Settings tab — feature status, license, cameras, processing
// health + the public-dashboard / data-ingest integration panel. Scoped to the
// PPE scenario; edits here never touch any other scenario's settings.
// =============================================================================
...
// PPE-specific purpose blurb.
const scenarioPurpose = () =>
  "Detect helmet and vest compliance from selected cameras.";
